/**
 * =========================================================================
 * PRISM & LUCY AI PRO: 초기불교(Early Buddhism, 5부 니까야 Nikāya 원음) 지혜 엔진
 * =========================================================================
...
/**
 * 루시 AI 프로의 시스템 프롬프트에 주입할 초기불교 담마 마스터 인스트럭션 빌더
 */
export function buildEarlyBuddhismSystemPrompt(): string {
  return `
[🪷 루시 AI 프로: 초기불교(Early Buddhism, 5부 니까야 Nikāya) 담마 마스터 지혜 체계]
