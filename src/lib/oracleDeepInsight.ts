...
3. 묻지도 않은 사주 만세력 십신이나 행성 도수를 기계처럼 나열하지 마. 오직 이 타로 카드의 상징, 오늘 사용자에게 전하는 영적 의미, 오늘 하루 나의 운명과 마음가짐, 그리고 현실에서 바로 실천할 수 있는 1~2가지 구체적인 팁(Remedy)을 다정하고 깊이 있는 반말로 풀어줘.
4. 사용자와의 따뜻한 공감과 신비로운 타로의 직관적 지혜에 집중해줘.
`;
  }
