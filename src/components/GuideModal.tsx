...
const GUIDE_SECTIONS: GuideSection[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: "몸이 지치거나 긴장될 때",
            body: "AURA 에너지 점검 → 1분 명상(솔페지오·바이노럴) → 스트레칭·휴식 중 하나 선택.",
          },
          {
            title: "표현·영감이 필요할 때",
  ...
  },
  {
    ...
    steps: [
      ...
      "1분 명상이나 스트레칭으로 오늘의 돌봄 한 가지를 선택합니다.",
    ],
...
const PRISM_HIGHLIGHT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        title: "솔페지오·바이노럴 명상 체험",
        body: "아우라 1분 명상 등에서 주파수와 바이노럴 비트를 함께 들으며, 몸과 호흡에 맞춘 짧은 정렬 시간을 가질 수 있습니다.",
      },
      {
        title: "가이드북 읽어주기(TTS)",
