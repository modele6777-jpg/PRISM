...
const GUIDE_SECTIONS: GuideSection[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: "몸이 지치거나 긴장될 때",
            body: "AURA 에너지 점검 → 오늘의 추천 음식(체질·에너지 맞춤 치유식) → 스트레칭·휴식 중 하나 선택.",
          },
          {
            title: "표현·영감이 필요할 때",
  ...
  },
  {
    ...
    steps: [
      ...
      "오늘의 추천 음식(치유식·차 테라피)이나 스트레칭으로 오늘의 돌봄 한 가지를 선택합니다.",
    ],
...
const PRISM_HIGHLIGHT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        title: "맞춤 치유식·영양 테라피",
        body: "아우라 오늘의 추천 음식 등에서 생체 에너지와 신체 컨디션에 맞춘 맞춤형 치유식과 차(Tea) 테라피를 안내받을 수 있습니다.",
      },
      {
        title: "가이드북 읽어주기(TTS)",
