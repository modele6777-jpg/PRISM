...
export function PrismGatewayFabButton({ className = "" }: PrismGatewayFabButtonProps) {
  ...
  const handleClick = () => {
    ...
    if (typeof window !== "undefined") {
      ...
      // Seamless direct transition to main Prism portal
